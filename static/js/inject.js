// Yandex.Metrika — counter 109515811
(function(m,e,t,r,i,k,a){m[i]=m[i]||function(){(m[i].a=m[i].a||[]).push(arguments)};
m[i].l=1*new Date();
for(var j=0;j<document.scripts.length;j++){if(document.scripts[j].src===r){return;}}
k=e.createElement(t),a=e.getElementsByTagName(t)[0],k.async=1,k.src=r,a.parentNode.insertBefore(k,a)}
)(window,document,'script','https://mc.yandex.ru/metrika/tag.js','ym');
ym(109515811,'init',{clickmap:true,trackLinks:true,accurateTrackBounce:true,webvisor:true});
...
(function(){
    ...
    wrap.innerHTML = '<div id="vid_vpaut_div" style="display:inline-block;width:600px;height:320px" vid_vpaut_pl="46635"></div>';
...
// Market-Place / MPSU ads for moto-gid.vercel.app
// Articles only: horizontal after 1st, 5th, and 9th paragraphs, corner sticker
(function () {
  var MPSU_SCRIPT_SRC = 'https://statika.mpsuadv.ru/scripts/11560.js';
  ...
  function initMpsuAds() {
    ...
    loadMpsuScript();
    // Rotator Static ZBT moto-gid.vercel.app horizontal 1 №44983
    insertAfterParagraph(44983, 1);
    // Rotator Static ZBT moto-gid.vercel.app horizontal 2 №44984 <div id="mp_custom_44984"></div>
    insertAfterParagraph(44984, 5);
    // Rotator Static ZBT moto-gid.vercel.app horizontal 3 №44985 <div id="mp_custom_44985"></div>
    insertAfterParagraph(44985, 9);
    // Rotator Recom V moto-gid.vercel.app №44987 <div id="mp_custom_44987"></div>
    appendFloating(44987);
  }
